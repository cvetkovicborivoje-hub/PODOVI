...
export const products: Product[] = [
  ...
  // Links to be added by user one by one
  {
    ...
    specs: [
      ...
      { key: 'format', label: 'Format', value: 'Plank / Tile' },
  ...
  },
  {
    ...
    description: 'Creation 40 je sintetička, dekorativna i fleksibilna PVC podna obloga dostupna u plankama i pločicama. Sadrži 0.40mm sloj habanja i visokokvalitetni dekorativni film. Sa ukupnom debljinom od 2mm, Creation 40 ima crosslinked poliuretanski površinski tretman (Protecshield) koji osigurava lako održavanje i povećanu otpornost na habanje.',
    ...
    specs: [
      ...
      { key: 'format', label: 'Format', value: 'Planka' },
