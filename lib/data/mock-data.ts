...
export const products: Product[] = [
  ...
  {
    id: '38',
    name: 'DLW Marmorette Arten',
    slug: 'dlw-marmorette-arten',
    sku: 'DLW-MARART',
    categoryId: '7',
    brandId: '6',
    shortDescription: 'Linoleum kolekcija Marmorette Arten',
    description: 'DLW Marmorette Arten linoleum kolekcija. Pogledajte kompletnu ponudu na Gerflor sajtu.',
    images: [{ id: '38-1', url: '/images/products/gerflor-linoleum.jpg', alt: 'DLW Marmorette Arten', isPrimary: true, order: 1 }],
    specs: [
      { key: 'type', label: 'Tip', value: 'Linoleum' },
      { key: 'link', label: 'Katalog', value: 'www.gerflor-cee.com' },
    ],
