...
export const products: Product[] = [
  ...
  {
    id: '16',
    name: 'Gerflor Creation 55 Loose Lay',
    slug: 'gerflor-creation-55-loose-lay',
    sku: 'GER-C55LL',
    categoryId: '2',
    brandId: '6',
    shortDescription: 'LVT kolekcija Loose Lay sistem',
    description: 'Creation 55 Loose Lay LVT kolekcija - vinil bez lepljenja. Pogledajte kompletnu ponudu na Gerflor sajtu.',
    images: [{ id: '16-1', url: '/images/products/gerflor-lvt.jpg', alt: 'Gerflor Creation 55 Loose Lay', isPrimary: true, order: 1 }],
    specs: [
  ...
  {
    id: '17',
    name: 'Gerflor Creation 55 Loose Lay Acoustic',
    slug: 'gerflor-creation-55-loose-lay-acoustic',
    sku: 'GER-C55LLA',
    categoryId: '2',
    brandId: '6',
    shortDescription: 'LVT kolekcija Loose Lay sa akustikom',
    description: 'Creation 55 Loose Lay Acoustic LVT kolekcija - vinil bez lepljenja sa zvučnom izolacijom. Pogledajte kompletnu ponudu na Gerflor sajtu.',
    images: [{ id: '17-1', url: '/images/products/gerflor-lvt.jpg', alt: 'Gerflor Creation 55 Loose Lay Acoustic', isPrimary: true, order: 1 }],
    specs: [
      { key: 'type', label: 'Tip', value: 'LVT Loose Lay Acoustic' },
      { key: 'link', label: 'Katalog', value: 'www.gerflor-cee.com' },
    ],
    price: 0,
    priceUnit: 'm²',
