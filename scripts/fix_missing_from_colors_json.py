...
# -*- coding: utf-8 -*-
"""
Popunjava kolekcije koje nemaju podatke - koristi _colors.json fajlove
"""
...
# Mapping: collection -> colors.json file
collection_mappings = {
    'creation-40-clic': 'creation-40-clic-new-collection_colors.json',
    'creation-40-clic-acoustic': 'creation-40-clic-acoustic-new-collection_colors.json',
    'creation-55-clic': 'creation-55-clic-new-collection_colors.json',
    'creation-55-clic-acoustic': 'creation-55-clic-acoustic-new-collection_colors.json',
    'creation-70': 'creation-70-new-collection_colors.json',
    'creation-70-clic': 'creation-70-clic-5mm-new-collection_colors.json',
}

lvt_dir = Path('downloads/product_descriptions/lvt')
total_updated = 0

for coll_name, file_name in collection_mappings.items():
    file_path = lvt_dir / file_name
    
    if not file_path.exists():
        print(f'  ⚠️  {coll_name}: nema {file_name}')
        continue
